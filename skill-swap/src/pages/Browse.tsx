        ...
        <section className="flex flex-row gap-20 flex-wrap justify-between">
          ...
          <div className="flex flex-col flex-1 rounded-lg shadow-2xl">
            ...
            <div className="flex flex-col gap-2 justify-center items-center">
              ...
              <h2 className="archivo-700 text-3xl">Yelling Cat</h2>
            </div>
            <div className="flex flex-row gap-10 p-10">
              <div className="flex flex-col w-1/2 gap-2">
                <div className="flex flex-row gap-2 items-center">
                  ...
                  <span className="archivo-700 text-xl">Skills to Teach</span>
                </div>
                <div className="flex flex-row gap-2">
                  ...
                  <span className="inter-400">Web Development</span>
                </div>
                <div className="flex flex-row gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="inter-400">UX/UI Design</span>
                </div>
                <div className="flex flex-row gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="inter-400">Cooking</span>
                </div>
              </div>
              ...
              <div className="flex flex-col w-1/2 gap-2">
                <div className="flex flex-row gap-2 items-center">
                  ...
                  <span className="archivo-700 text-xl">Skills to Learn</span>
                </div>
                <div className="flex flex-row gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="inter-400">Eating</span>
                </div>
                <div className="flex flex-row gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="inter-400">Sleeping</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 p-10">
              ...
              <p>
                ...
                building intuitive user interfaces. I love learning new
                technologies and am currently keen to expand my skills in
                digital marketing strategies and photography.
              </p>
            </div>
